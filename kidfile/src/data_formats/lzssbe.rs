...
pub const ENTRY_LZSSBE: Decoder<Box<[u8]>> = Decoder {
	id: "lzssbe",
	desc: "LZSS-like with big-endian header",
	detect: |buf| Certainty::certain_if(buf.starts_with_at(b"ogdt", 7) || buf.starts_with_at(b"TIM2", 7) || buf.starts_with_at(b"PVRT", 7)),
	decode
};
